.NET MVC AngularJS Sample Project

This project is a simple web application which calculates a life insurance estimate based on the formula:

Cover Amount Calculation = (Mortgage or Rent*12*20) + (no. of Children * 50,000) + Debt

And the following 3 questions:
